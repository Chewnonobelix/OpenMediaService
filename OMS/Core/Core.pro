...
third.commands += $$quote(cmd /c xcopy /Y /S /I $$shell_path($${PWD}//..//3rdParty//*.exe) $$shell_path($${PWD}//..//3rdParty//*.dll) $$shell_path($${OUT_PWD}//..//Application//3rdParty))

QMAKE_EXTRA_TARGETS += smart tr third
POST_TARGETDEPS += smart tr third
